...
- [~] 6.5c — layered trust model for sensitive screens (spec:
  ...
  6.5c-1 redaction ✅; 6.5c-2 human handoff/takeover ✅; 6.5c-2b login tap-to-fill ✅ (best-effort
  focus → OS autofill chip); → 6.5c-3 scoped trust → 6.5c-4 injection hardening → 6.5c-5
  risk-adaptive confirm + transparency.

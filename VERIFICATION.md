...
- [ ] **V142. Snapshot diff + stuck detection**: run a multi-step task. Pass: after an action that
  changes the screen, the next tool-result text begins with a "Screen changed: …" line, and an
